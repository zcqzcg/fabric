...
const RSAKey = require('./rsa/key.js');
			...
			.then((raw) => {
				if (raw !== null) {
                    ...
                    if (privKey.type){
                        ...
                        throw 'Error: This key implementation only supports keys generated by jsrsasign.KEYUTIL. It must have a "type" property'
                    }
				...
				if (key instanceof ECDSAKey || key instanceof RSAKey) {
					return key;
				}
